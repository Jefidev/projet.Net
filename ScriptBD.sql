...
(
	...
	Position VARCHAR(40),
	DateDefaut DATE CONSTRAINT NN_DATEDEFAUT CHECK (DateDefaut IS NOT NULL)
);
...
(
	...
	IdDefaut INT CONSTRAINT FK_INTERVENTIONS_DEFAUT REFERENCES DEFAUTS(IdDefaut),
	Mail VARCHAR(50) CONSTRAINT FK_INTERVENTIONS_PERSONNE REFERENCES PERSONNES(Mail),
	CONSTRAINT NN_DEFAUT CHECK (IdDefaut IS NOT NULL)
);
